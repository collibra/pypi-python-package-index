# collibra_catalog_cloud_ingestions.ADLSApi

All URIs are relative to */rest/catalog/1.0*

Method | HTTP request | Description
------------- | ------------- | -------------
[**add_crawler**](ADLSApi.md#add_crawler) | **POST** /filesystem/{fileSystemType}/{assetId}/crawlers | Add a crawler
[**add_schedule**](ADLSApi.md#add_schedule) | **POST** /filesystem/{fileSystemType}/{assetId}/schedule | Add a synchronization schedule
[**attach_capability**](ADLSApi.md#attach_capability) | **PUT** /filesystem/{fileSystemType}/{assetId}/capability | Add a capability
[**cancel**](ADLSApi.md#cancel) | **DELETE** /filesystem/{fileSystemType}/{assetId}/synchronize | Schedule canceling of cloud synchronization
[**delete_crawler**](ADLSApi.md#delete_crawler) | **DELETE** /filesystem/{fileSystemType}/{assetId}/crawlers | Delete a crawler
[**delete_schedule**](ADLSApi.md#delete_schedule) | **DELETE** /filesystem/{fileSystemType}/{assetId}/schedule | Delete a synchronization schedule
[**detach_capability**](ADLSApi.md#detach_capability) | **DELETE** /filesystem/{fileSystemType}/{assetId}/capability | Remove a capability
[**find_filesystem_asset_ids_for_capability**](ADLSApi.md#find_filesystem_asset_ids_for_capability) | **GET** /filesystem | Find filesystem assets that have the given Edge capability attached
[**get_attached_capability_id**](ADLSApi.md#get_attached_capability_id) | **GET** /filesystem/{fileSystemType}/{assetId}/capability | Retrieve a capability
[**get_crawlers**](ADLSApi.md#get_crawlers) | **GET** /filesystem/{fileSystemType}/{assetId}/crawlers | List crawlers
[**get_schedule**](ADLSApi.md#get_schedule) | **GET** /filesystem/{fileSystemType}/{assetId}/schedule | Retrieve a synchronization schedule
[**synchronize_file_system**](ADLSApi.md#synchronize_file_system) | **POST** /filesystem/{fileSystemType}/{assetId}/synchronize | Synchronize a file system
[**update_crawler**](ADLSApi.md#update_crawler) | **PUT** /filesystem/{fileSystemType}/{assetId}/crawlers | Update a crawler
[**update_schedule**](ADLSApi.md#update_schedule) | **PUT** /filesystem/{fileSystemType}/{assetId}/schedule | Update a synchronization schedule
